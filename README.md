...
| [`pubg-paradrop-task-runner.user.js`](./outputs/pubg-paradrop-task-runner.user.js) | 任务专用 | 当前第三版；固定 `1x`，`300` 分后直接追踪空投 |
| [`pubg-paradrop-task-runner-normal-walk-backup.user.js`](./outputs/pubg-paradrop-task-runner-normal-walk-backup.user.js) | 任务专用备用 | 固定 `1x`；空投按正常走路速度追踪 |
