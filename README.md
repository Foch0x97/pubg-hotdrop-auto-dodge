...
| [`pubg-paradrop-task-runner.user.js`](./outputs/pubg-paradrop-task-runner.user.js) | 任务专用 | 开局自动承受一次 NPC 伤害后关闭碰撞；`300` 分后角色自动追踪空投；按手动输入的分数结算 |
